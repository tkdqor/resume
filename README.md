...
- DRF 프레임워크의 **APIView, ModelSerializer**로 **RESTful한 API 서버**를 개발해 본 경험이 있습니다.
...
- 프로젝트 진행 시, 관계설정(1:N, M:N 등)을 바탕으로 **모델링**을 설정할 수 있습니다.
...
- Github Repository에 **프로젝트 칸반보드**를 이용해서 **Issue**들을 관리합니다.
...
## 원티드 프리온보딩 백엔드코스 3차 - (주)랩큐 기업과제 `팀 프로젝트(5명)`
